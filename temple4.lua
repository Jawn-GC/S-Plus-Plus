...
level_var.load_level = function()
	...
	level_state.callbacks[#level_state.callbacks+1] = set_callback(function ()
		...
		if frames == 0 then
			...
			enemy_uid = get_entities_by_type(ENT_TYPE.MONS_AMMIT, ENT_TYPE.MONS_NECROMANCER)
			...
			if #players ~= 0 then
				players[1]:give_powerup(ENT_TYPE.ITEM_POWERUP_HEDJET)
				players[1]:give_powerup(ENT_TYPE.ITEM_POWERUP_SPECTACLES)
			end
		end
...
level_var.unload_level = function()
	...
	replace_drop(DROP.NECROMANCER_RUBY, ENT_TYPE.ITEM_RUBY)

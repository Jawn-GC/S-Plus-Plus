...
local tidepool3 = {
    ...
    title = "[Episode D, Level 3] Undead",
...
tidepool3.load_level = function()
	...
	replace_drop(DROP.JIANGSHI_SPRINGSHOES, ENT_TYPE.ITEM_BLOOD)
	...
	level_state.callbacks[#level_state.callbacks+1] = set_callback(function ()
		...
		if frames == 0 then
			...
			enemy_uid = get_entities_by_type(ENT_TYPE.MONS_JIANGSHI)
...
tidepool3.unload_level = function()
	...
	replace_drop(DROP.JIANGSHI_SPRINGSHOES, ENT_TYPE.ITEM_PICKUP_SPRINGSHOES)

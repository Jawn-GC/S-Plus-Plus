...
temple1.load_level = function()
	...
	replace_drop(DROP.CROCMAN_TELEPACK, ENT_TYPE.ITEM_BLOOD)
	replace_drop(DROP.CROCMAN_TELEPORTER, ENT_TYPE.ITEM_BLOOD)
	...
	level_state.callbacks[#level_state.callbacks+1] = set_callback(function ()
		...
		if frames == 0 then
			...
			enemy_uid = get_entities_by_type(ENT_TYPE.MONS_CROCMAN)
			for i = 1,#enemy_uid do
				enemies_dead[i] = false
			end

			for i = 1,#emeralds do
				emeralds[i].x = emeralds[i].x + 0.5
			end
...
temple1.unload_level = function()
	...
	replace_drop(DROP.CROCMAN_TELEPACK, ENT_TYPE.ITEM_TELEPORTER_BACKPACK)
	replace_drop(DROP.CROCMAN_TELEPORTER, ENT_TYPE.ITEM_TELEPORTER)

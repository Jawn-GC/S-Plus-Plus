...
local level_var = {
    ...
    title = "[Episode E, Level 1] Sanctuary",
...
level_var.load_level = function()
	...
	replace_drop(DROP.YETI_PITCHERSMITT, ENT_TYPE.ITEM_BLOOD)
	...
	level_state.callbacks[#level_state.callbacks+1] = set_callback(function ()
		...
		if frames == 0 then
			...
			enemy_uid = get_entities_by_type(ENT_TYPE.MONS_SNAKE, ENT_TYPE.MONS_YETI, ENT_TYPE.MONS_FROG, ENT_TYPE.MONS_TADPOLE)
...
level_var.unload_level = function()
	...
	replace_drop(DROP.YETI_PITCHERSMITT, ENT_TYPE.ITEM_PICKUP_PITCHERSMITT)
